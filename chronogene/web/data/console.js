window.CONSOLE_DATA = {
  ...
  "generated_at": "Wednesday 05 August 2026 · 07:00",
    ...
    "items": [
      {
        "status": "RUNNING",
        "meta": "NCBI GEO",
        "title": "Does the blood ageing-clock signal hold in liver tissue?",
        "stages": [
          {
            "name": "Commissioned",
            "state": "done"
        ...
        "desc": "Three public series retrieved; analysis running."
      },
      {
        "status": "INDEPENDENT CHECK",
        "meta": "PubMed + NCBI GEO",
        "title": "Re-test a widely cited longevity variant in an independent cohort.",
        "stages": [
          {
            "name": "Commissioned",
            "state": "done"
        ...
        "desc": "Candidate written up; with the checkers now."
      }
    ]
  },
  "learned": {
  ...
  "bench": {
    "title": "Instruments",
    "meta": "2 of 3 connected",
    "teams": [
      {
        "name": "NCBI GEO (public datasets)",
        "desc": "Search and summarise public GEO series. Free; rate-limited without a key.",
        "status": "CONNECTED",
        "dot": "green"
      },
      {
        "name": "PubMed (public literature)",
        "desc": "Sweep the public literature for open, testable questions.",
        "status": "CONNECTED",
        "dot": "green"
      },
      {
        "name": "Claude Science",
        "desc": "Claude Science is not connected. Set CLAUDE_SCIENCE_MCP_URL + CLAUDE_SCIENCE_MCP_TOKEN (preferred) or CLAUDE_SCIENCE_API_URL + CLAUDE_SCIENCE_API_KEY.",
